...
StateModifiersDictK2 = {0: "Unk0", 1: "In Heat Mode", 2: "Unk2", 3: "Run Startup to Full Run", 4: "Enemy Down, Including getting up Animation", 5: "Enemy Standing", 6: "Unk6", 7: "Enemy Down from the Front", 8: "Enemy Down from Behind", 9: "Unk9", 10: "Unk10", 11: "Unk11", 12: "Unk12", 13: "Unk13", 14: "Unk14", 15: "Unk15", 16: "Unk16", 17: "Unk17", 18: "Unk18", 19: "Near Wall", 20: "Unk21", 22: "Unk22", 23: "Unk24", 25: "Unk25", 26: "Unk26", 27: "Unk27", 28: "Unk28", 29: "Unk29", 30: "Unk30", 31: "Full Run", 32: "Unk32", 33: "Unk33", 34: "Unk34", 35: "Unk35", 36: "Unk36", 37: "Unk37", 38: "Unk38", 39: "Unk39", 40: "Unk40", 41: "Unk41", 42: "Unk42", 43: "Unk43"}
StateModifiersDictOE = StateModifiersDictK2
...
ButtonPressConditionalsOE = ButtonPressConditionalsDE
		...
		while a < NumHactSets:
			...
			while c < NumTargets + 1:
				...
				while d < numfollowupprops + 1:
					...
					propbyteex1 = int.from_bytes(f.read(1),"little")
					propbyteex2 = int.from_bytes(f.read(1),"little")
					propbyteex3 = int.from_bytes(f.read(1),"little")
					propbyteex4 = int.from_bytes(f.read(1),"little")
					...
					if propint2 == 41:
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Property Type"] = propint2
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 1"] = propbyte1
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 2"] = propbyte2
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 3"] = propbyte3
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 4"] = propbyte4
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 5"] = propbyteex1
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 6"] = propbyteex2
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 7"] = propbyteex3
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 8"] = propbyteex4
					if propint2 == 48:
						temp = GetStringFromPointer(f, propint1)
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Property Type"] = propint2
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Hact (Property)"] = temp
					else:
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Property Type"] = propint2
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 1"] = propbyte1
						CommandSetDictionary[(setname)]["Target Table"]["Target " + str(c)]["Target Properties"]["Property "+ str(d)]["Unk Byte 2"] = propbyte2
						...
						for target in list(jsonfile[commandsetname]["Target Table"].keys()):
							...
							if "Target Properties" in jsonfile[commandsetname]["Target Table"][target]:
								for property in list(jsonfile[commandsetname]["Target Table"][target]["Target Properties"].keys()):
									...
									propertytype = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Property Type"]
									if propertytype == 41:
										byte1 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 1"]
										byte2 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 2"]
										byte3 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 3"]
										byte4 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 4"]
										byte5 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 5"]
										byte6 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 6"]
										byte7 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 7"]
										byte8 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 8"]
										temparray2.append([propertytype, byte1,byte2,byte3,byte4,byte5,byte6,byte7,byte8])
									elif propertytype == 48:
										string = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Hact (Property)"]
										temparray2.append([propertytype, string])
									else:
										byte1 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 1"]
										byte2 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 2"]
										byte3 = jsonfile[commandsetname]["Target Table"][target]["Target Properties"][property]["Unk Byte 3"]
							...
							while x < numtargetprops:
								...
								while y < len(TargetPropValues[x]):
									...
									if TargetPropValues[x][y][0] == 41:
										newfile.write(int_to_bytes(TargetPropValues[x][y][1], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][2], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][3], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][4], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][5], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][6], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][7], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][8], 1))
										newfile.write(int_to_bytes(TargetPropValues[x][y][0], 4))
										newfile.write(b'\x00\x00\x00\x00')
									elif TargetPropValues[x][y][0] == 48:
										newfile.write(int_to_bytes(stringpointerdict[TargetPropValues[x][y][1]], 4))
										newfile.write(b'\x00\x00\x00\x00')
										newfile.write(int_to_bytes(TargetPropValues[x][y][0], 4))
										newfile.write(b'\x00\x00\x00\x00')
									else:
